...
::
::tab{title="Okta"}
Okta users are sent to `https://$OKTA_TENANT/login/signout` to sign out.
::
::tab{title="Duo"}
...
:::info
An Okta administrator [can configure Okta’s signout page](https://help.okta.com/oie/en-us/Content/Topics/Settings/settings-configure-sign-out.htm).
:::
